    ...
    if recon_log.exists():
        ...
        with open(recon_log, "r") as f:
            ...
            for line in f:
                ...
                # Median RR format 2:
                # INFO:Get Gate bins:Median RR = 1.058
...
new_flow = "/home/bxa033/Data/CVMRIGroup/Users/bxa033/trtstudyvol2/espirit/pils/pythonRecon/Flow3D.h5"
...
with h5py.File(new_flow, "r") as f:
    ...
    print("\n=== /Header Datasets ===")
    for name, dataset in header.items():
        print(f"\n{name}:")
        print(dataset[()])
#%%
