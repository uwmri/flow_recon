...
if __name__ == '__main__':
    ...
    for idx, f in enumerate(files_to_compare):
        ...
        #os.system(command)
        #os.rename('FullRecon.h5', f'Cardiac001.h5')
        ...
        command = (
                    ...
                    '--gate_type time '
                    '--lamda 1e-8 '
                    '--epochs 200 ' #'--max_encodes 1 '  '--strided_gate '   '--shots_per_frame 200 '
                    '--compress_coils 20 '
                    '--max_encodes 1 '
                    '> recon.log'
                )
        
        #command = 'python /home/larivera/CODE/RECON/python_recon/flow_recon/llr_recon_flow.py --filename MRI_Raw.h5 --thresh_maps --strided_gate --shots_per_frame 4 --recon_type llr --max_iter 200 --llr_block_width 8 --frames 500 --gate_type time --lamda 0.0015 > recon.log'
        #os.rename('FullRecon.h5', 'Time0015.h5')
        os.system(command)
        os.rename('FullRecon.h5', 'Cardiac_mslr.h5') 
