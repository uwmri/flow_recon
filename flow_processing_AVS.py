...
if __name__ == "__main__":
    ...
    with h5py.File(args.filename, 'r') as hf:
        ...
        if 'IMAGE' in hf:
            ...
            if images.ndim != 5:
                raise ValueError(f"Expected /IMAGE to be 5D but got shape {images.shape}")
            
            frames =  images.shape[0]
            num_encodes = images.shape[1]
            ...
            raise KeyError("Could not find either /IMAGE or /Images in Images.h5 file")
